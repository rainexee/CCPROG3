...
/*
 * Player class that represents the player, the animals they own, if player won and the room they will initialize in
 */
public class Player {
	Room room;
	int playerID;
	...
	/*Player setter
	 * Sets the playerID and their room
	 */
	...
	/*
	 * winState setter
	 * returns winState from the parameter winner 
	 * @param winner as an int
	 */
	public int setWinState(int winner) {
		return this.winState = winner;
	}
	/*Method that initializes animals to each player based on their pID
	 * @param pID - unqiue Player ID
	 */
	...
	/*setter room
	 * sets the players room based on the parameter r
	 * @param r	- room number
	 */
	public void setRoom(Room r) {
		this.room = r;
	}
	/*selectAnimal method is for the player based on their turn to select the animal they want to use
	 * 
	 */
	...
	/*moveAnimal method is for the players to move their animals on the board using W A S D input
	 * and also checks if their animal is alive. It also makes sure the user can't go out of bounds of the array
	 * it also checks if the animals can battle
	 */
	...
	/*moveRight method is for moving the selected animal to the right of the board
	 * 
	 */
...
/*
 * moveLeft method is for moving the selected animal to the left of the board
 */
...
/*moveUp method moves the selected animal up on the board
 * 
 */
    public void moveUp() {
...
/*moveDown method moves the selected animal down on the board.
 * 
 */
	...
	/*
	 * endTurn method ends the players turn and switches it to the other player once movement has been concluded
	 */
	public void endTurn() {
	...
	/*returnToSelect method returns the user to select an animal if they wish to change animals.
	 * 
	 */
	...
	/*removeAnimal method removes the animal from the array of the player whos animal got captured 
	 * @param deadAnimal
	 */
